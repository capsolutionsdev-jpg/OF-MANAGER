...
export const config = {
  ...
  matcher: [
    "/((?!api/auth|api/cron|api/pdf-test|_next/static|_next/image|favicon.ico|login|inscription|parcours|signer|satisfaction|compte-rendu|contrat-formateur|emarger|.*\\..*).*)",
  ],
};
