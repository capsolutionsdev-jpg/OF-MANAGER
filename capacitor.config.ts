 ...
 * https://app.ofmanager.fr. Avantage = mise à jour instantanée (pas de
...
const config: CapacitorConfig = {
  ...
  server: {
    ...
    url: "https://app.ofmanager.fr/dashboard",
    // HTTPS uniquement (pas de trafic en clair).
    cleartext: false,
    // Domaines autorisés à s'ouvrir DANS la webview (le reste part au navigateur).
    allowNavigation: ["app.ofmanager.fr"],
    // Si app.ofmanager.fr est injoignable au lancement, afficher l'écran de repli
