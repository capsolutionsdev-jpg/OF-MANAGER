...
const STATUTS: Record<string, { label: string; cls: string }> = {
  NOUVELLE: { label: "Nouvelle", cls: "bg-red-100 text-red-700" },
  ACCUSE_RECEPTION: { label: "AR envoyé", cls: "bg-amber-100 text-amber-700" },
  EN_TRAITEMENT: { label: "En traitement", cls: "bg-blue-100 text-blue-700" },
  CLOTUREE: { label: "Clôturée", cls: "bg-emerald-100 text-emerald-700" },
};
