    ...
    <main className="min-h-screen bg-white text-[#0D1B3E]">
      ...
      <section className="text-white" style={{ background: `radial-gradient(900px 500px at 80% -10%, #3A3550, transparent 60%), linear-gradient(180deg, ${NAVY}, #0D1B3E)` }}>
        <div className="mx-auto max-w-5xl px-4 py-16 sm:px-6">
          ...
          <h1 className="mt-5 max-w-3xl text-4xl font-extrabold leading-tight sm:text-5xl">TFP APS : du <span className="text-[#3B6EF5]">CNAPS</span> à la <span className="text-[#3B6EF5]">certification</span>, géré de bout en bout</h1>
        ...
        <div className="mt-12 space-y-5">
          {steps.map((s, i) => (
            <div key={s.n} className="relative grid grid-cols-[56px_1fr] gap-5">
              ...
              <div className="z-10 grid h-12 w-12 place-items-center rounded-2xl text-lg font-extrabold text-white" style={{ background: s.n === 1 ? "#3B6EF5" : NAVY }}>{s.n}</div>
              <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
                <h3 className="font-bold text-[#0D1B3E]">{s.t}</h3>
                <p className="mt-1.5 text-sm text-slate-600">{s.d}</p>
                <div className="mt-3 flex flex-wrap gap-2">
                  {s.chips.map((c) => <span key={c} className="rounded-full bg-[#3B6EF5]/10 px-3 py-1 text-xs font-semibold text-[#3B6EF5]">{c}</span>)}
                </div>
              </div>
            </div>
          ))}
      ...
      <section className="text-white" style={{ background: `linear-gradient(135deg, #3B6EF5, #2A2740)` }}>
      ...
      <section className="border-t border-slate-100 bg-white py-8">
        <div className="mx-auto flex max-w-5xl flex-wrap items-center justify-center gap-x-6 gap-y-2 px-4 text-sm text-slate-500 sm:px-6">
          <span className="font-semibold text-[#0D1B3E]">Voir aussi :</span>
          <Link href="/solutions/ssiap" className="hover:text-[#3B6EF5]">SSIAP</Link>
          <Link href="/solutions/sst" className="hover:text-[#3B6EF5]">SST</Link>
          <Link href="/solutions/vtc-taxi" className="hover:text-[#3B6EF5]">VTC / Taxi</Link>
          <Link href="/solutions/qualiopi" className="hover:text-[#3B6EF5]">Qualiopi</Link>
        </div>
      </section>
