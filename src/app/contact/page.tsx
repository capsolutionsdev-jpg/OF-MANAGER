    ...
    <main className="min-h-screen bg-slate-50 text-[#0D1B3E]">
      <header className="border-b border-slate-100 bg-white">
        <div className="mx-auto flex h-16 max-w-6xl items-center justify-between px-4 sm:px-6">
          <Link href="/"><Logo /></Link>
          <Link href="/" className="text-sm font-medium text-slate-500 hover:text-[#3B6EF5]">← Retour au site</Link>
        </div>
      </header>

      <div className="mx-auto grid max-w-6xl gap-10 px-4 py-12 sm:px-6 lg:grid-cols-[1fr_1.1fr]">
        <div>
          <span className="inline-flex items-center gap-2 rounded-full bg-[#3B6EF5]/10 px-3 py-1 text-xs font-semibold text-[#3B6EF5]">On vous rappelle sous 24 h</span>
          <h1 className="mt-5 text-3xl font-bold leading-tight sm:text-4xl">Parlons de votre <span className="text-[#3B6EF5]">organisme</span></h1>
          ...
          <ul className="mt-7 space-y-3 text-sm text-slate-700">
            <li className="flex items-center gap-2.5"><Mail className="h-4 w-4 text-[#3B6EF5]" /> contact@ofmanager.info</li>
            <li className="flex items-center gap-2.5"><Phone className="h-4 w-4 text-[#3B6EF5]" /> 01 23 45 67 89</li>
            <li className="flex items-center gap-2.5"><Clock className="h-4 w-4 text-[#3B6EF5]" /> Réponse sous 24 h ouvrées</li>
          </ul>
