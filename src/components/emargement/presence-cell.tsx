...
export function PresenceCell({
  ...
  return (
    <select
      ...
      onChange={onChange}
      disabled={isPending}
      className="h-7 rounded border border-input bg-transparent px-1.5 text-xs outline-none focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50"
    >
