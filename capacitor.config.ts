 ...
 * https://ofmanager.info. Avantage = mise à jour instantanée (pas de
...
const config: CapacitorConfig = {
  ...
  server: {
    ...
    url: "https://ofmanager.info/dashboard",
    // HTTPS uniquement (pas de trafic en clair).
    cleartext: false,
    // Domaines autorisés à s'ouvrir DANS la webview (le reste part au navigateur).
    allowNavigation: ["ofmanager.info"],
    // Si ofmanager.info est injoignable au lancement, afficher l'écran de repli
