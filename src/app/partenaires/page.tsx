...
export default function PartenairesPage() {
  return (
    <main className="min-h-screen bg-white text-[#0D1B3E]">
      ...
      <section className="text-center text-white" style={{ background: `radial-gradient(900px 500px at 80% -10%, #1c2f6e, transparent 60%), linear-gradient(180deg, ${NAVY}, #0a1430)` }}>
        <div className="mx-auto max-w-3xl px-4 py-16 sm:px-6">
          ...
          <h1 className="mt-5 text-4xl font-extrabold sm:text-5xl">Nos <span className="text-[#4D9FFF]">partenaires</span> &amp; <span className="text-[#4D9FFF]">clients</span></h1>
      ...
      <section className="mx-auto max-w-5xl px-4 py-16 text-center sm:px-6">
        <p className="text-xs font-bold uppercase tracking-[0.14em] text-[#1A5FD4]">Ils utilisent OFManager</p>
      ...
      <section className="bg-slate-50/70 py-16">
        <div className="mx-auto max-w-5xl px-4 text-center sm:px-6">
          <p className="text-xs font-bold uppercase tracking-[0.14em] text-[#1A5FD4]">Écosystème</p>
