  ...
  return (
    <main className="min-h-screen bg-slate-50 text-[#0D1B3E]">
      ...
      <div className="mx-auto grid max-w-6xl gap-10 px-4 py-12 sm:px-6 lg:grid-cols-[1fr_1.1fr]">
        <div>
          <span className="inline-flex items-center gap-2 rounded-full bg-[#1A5FD4]/10 px-3 py-1 text-xs font-semibold text-[#1A5FD4]">
            Démo personnalisée · réponse sous 24 h
          </span>
          <h1 className="mt-5 text-3xl font-bold leading-tight sm:text-4xl">
            Voyez OFManager gérer <span className="text-[#1A5FD4]">vos formations</span>
          </h1>
