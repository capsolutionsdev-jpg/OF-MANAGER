...
export const config = {
  ...
  matcher: [
    "/((?!api/auth|api/cron|api/pdf-test|api/lead|api/demo|api/stripe|api/public|api/verification|api/civique|_next/static|_next/image|favicon.ico|login|inscription|tarifs|demo|contact|solutions|partenaires|prospect|parcours|signer|satisfaction-entreprise|satisfaction|positionnement|francais|reclamer|compte-rendu|contrat-formateur|emarger|devis-accept|portail/|deconnexion|.*\\..*).*)",
  ],
};
