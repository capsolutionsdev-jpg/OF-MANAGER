...
export const config = {
  ...
  matcher: [
    "/((?!api/auth|api/cron|api/pdf-test|api/lead|api/demo|api/stripe|api/webhooks|api/public|api/verification|api/civique|api/health|api/version|_next/static|_next/image|favicon.ico|opengraph-image|twitter-image|login|verification|confidentialite|mentions-legales|cgv|qualification|fonctionnalites|guides|glossaire|anti-fraude|comparatif|inscription|tarifs|demo|contact|solutions|partenaires|prospect|parcours|signer|satisfaction-entreprise|satisfaction|positionnement|francais|suivi|reclamer|compte-rendu|contrat-formateur|emarger|devis-accept|portail/|deconnexion|securite-2fa|definir-mot-de-passe|mot-de-passe-oublie|reinitialisation|.*\\..*).*)",
  ],
};
